            ...
            <div className="container-fluid footer_bg" style={{"overflowX":"hidden"}}>
                ...
                <div className="row mb-3">
                    <div className="col-md-5 footer_text d-flex flex-wrap justify-content-around mx-auto text-center" id="footer_text">
                        <div className='mx-auto'> <i class="fa-solid fa-envelope"></i> singlaanirudha@gmail.com</div>
                        <div className='mx-auto'> <i className="fa-solid fa-phone me-1"></i> +91 9911598285</div>
                    </div>
                </div>
                ...
                <div className="row pb-4">
                    <div className="col-md-3 d-flex justify-content-around footer_social mx-auto ">
                        ...
                        <div> <a href="https://github.com/singlaanirudha" target="_blank"><i title="GitHub" className="fa-brands fa-github"></i></a> </div>
                        
                        <div> <a href="https://www.linkedin.com/in/anirudhasingla/" target="_blank"><i title="Linkedin" className="fa-brands fa-linkedin"></i></a> </div>
                        
                        <div> <a href="mailto: singlaanirudha@gmail.com"><i title="G-Mail" className="fa-solid fa-envelope-open"></i></a> </div>
                        
                        <div> <a href="tel: 9911598285" target="_blank"><i title="Call" className="fa-solid fa-phone"></i></a> </div>
                        
                        <div> <a href="https://wa.me/919911598285" target="_blank"><i title="What's App" className="fa-brands fa-whatsapp"></i></a> </div>
